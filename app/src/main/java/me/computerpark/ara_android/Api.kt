...
class Api : ScriptableObject() {
    ...
    companion object {
        ...
        fun off(scriptName: String): Boolean {
            ...
            if (scriptName == "undefined") {
                ...
                if (!File(Environment.getExternalStorageDirectory().toString() + File.separator + "arabot" + File.separator + scriptName).exists()) {
                    return false
                }
    ...
    public static Scriptable getScriptFiles(){
        ...
        File basePath = new File(Environment.getExternalStorageDirectory() + File.separator + "arabot");
        basePath.mkdir();
            ...
            try {
                NotificationListener.UIHandler!!.post {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        noti.setChannelId("me.computerpark.ara_android.customNotification")
                        ...
                        val mChannel = NotificationChannel("me.computerpark.ara_android.customNotification", name, NotificationManager.IMPORTANCE_HIGH)
