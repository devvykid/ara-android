...
class ScriptsManager {
    ...
    companion object {
        ...
        fun initializeScript(scriptName: String, isManual: Boolean, ignoreError: Boolean): Boolean {
            ...
            me.computerpark.ara_android.Log.info(MainApplication.context!!.resources.getString(R.string.snackbar_compileStart) + ": $scriptName")
            ...
            try {
                ...
                //ScriptableObject.putProperty(scope, "Log", Context.javaToJS(new me.computerpark.ara_android.Log(), scope));
                ...
                me.computerpark.ara_android.Log.info(MainApplication.context!!.resources.getString(R.string.snackbar_compiled) + ": $scriptName")
                ...
                if (NotificationListener.UIHandler != null) {
                    NotificationListener.UIHandler!!.post {
                        ...
                        me.computerpark.ara_android.Log.error(e.toString(), false)
                    }
                }
