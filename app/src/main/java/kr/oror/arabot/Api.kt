            ...
            try {
                NotificationListener.UIHandler!!.post {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        noti.setChannelId("kr.oror.arabot.customNotification")
                        ...
                        val mChannel = NotificationChannel("kr.oror.arabot.customNotification", name, NotificationManager.IMPORTANCE_HIGH)
