...
import kr.oror.arabot.MessageUI.MessageListAdapter
import kr.oror.arabot.MessageUI.UserMessage
import java.util.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendBtn.setOnClickListener(View.OnClickListener {
            ...
            val thr = Thread(Runnable {
                NotificationListener.callResponder(scriptName!!, room.text.toString(), msgTxt.text.toString(), sender.text.toString(), chk_groupchat.isChecked, ImageDB(BitmapFactory.decodeResource(MainApplication.context!!.resources, R.drawable.ic_bug_report_black_24dp)), "DEBUGMODE",/*id,*/ null, true)
