...
class ScriptsManager {
    ...
    companion object {
        ...
        fun initializeScript(scriptName: String, isManual: Boolean, ignoreError: Boolean): Boolean {
            ...
            val script = File(Environment.getExternalStorageDirectory().toString() + File.separator + "arabot" + File.separator + scriptName)
            ...
            kr.oror.arabot.Log.info(MainApplication.context!!.resources.getString(R.string.snackbar_compileStart) + ": $scriptName")
            ...
            try {
                ...
                //ScriptableObject.putProperty(scope, "Log", Context.javaToJS(new kr.oror.arabot.Log(), scope));
                ...
                ScriptableObject.defineClass(scope, kr.oror.arabot.Log::class.java)
                ...
                kr.oror.arabot.Log.info(MainApplication.context!!.resources.getString(R.string.snackbar_compiled) + ": $scriptName")
                ...
                if (NotificationListener.UIHandler != null) {
                    NotificationListener.UIHandler!!.post {
                        ...
                        kr.oror.arabot.Log.error(e.toString(), false)
                    }
                }
