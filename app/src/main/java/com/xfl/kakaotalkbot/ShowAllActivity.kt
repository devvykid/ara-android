...
class ShowAllActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menu.findItem(R.id.adjustToScreen).isChecked = getSharedPreferences("chatShowAll", 0).getBoolean("adjustToScreen", false)
        setAdjust(menu.findItem(R.id.adjustToScreen).isChecked)
